...
2. **Task Summary**: Total major tasks, sub-tasks, requirement coverage
3. **Quality Validation**: Requirements mapped, dependencies verified
...
- Stop. Suggest: "Run `/kiro:spec-tasks $1 -y` to auto-approve both and proceed"

**Missing Requirements or Design**:
- Stop. Suggest: "Complete requirements and design phases first"
...
- Without arguments: `/kiro:spec-impl $1` (all pending tasks - NOT recommended)
